"use strict";(()=>{var e={};e.id=656,e.ids=[656],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1282:e=>{e.exports=require("child_process")},4770:e=>{e.exports=require("crypto")},665:e=>{e.exports=require("dns")},7702:e=>{e.exports=require("events")},2048:e=>{e.exports=require("fs")},2615:e=>{e.exports=require("http")},8791:e=>{e.exports=require("https")},8216:e=>{e.exports=require("net")},9801:e=>{e.exports=require("os")},5315:e=>{e.exports=require("path")},6162:e=>{e.exports=require("stream")},2452:e=>{e.exports=require("tls")},7360:e=>{e.exports=require("url")},1764:e=>{e.exports=require("util")},1568:e=>{e.exports=require("zlib")},6917:(e,o,r)=>{r.r(o),r.d(o,{originalPathname:()=>x,patchFetch:()=>g,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>l,staticGenerationAsyncStorage:()=>m});var t={};r.r(t),r.d(t,{POST:()=>d});var a=r(9303),n=r(8716),i=r(670),s=r(7070),p=r(6119);async function d(e){try{let e=(0,p.AY)("Test User","This is a test rejection message to verify the email system is working correctly. Thanks for organizing our community!","This is a test rejection for development purposes. In a real scenario, this would contain the actual reason for rejection."),o=await (0,p.Cz)({to:"tmgd.og1@gmail.com",subject:"Test Rejection Email - Thank You Thomas System",html:e});if(o.success)return console.log("Test rejection email sent successfully to tmgd.og1@gmail.com"),s.NextResponse.json({success:!0,message:"Test rejection email sent successfully",messageId:o.messageId});return console.error("Failed to send test rejection email:",o.error),s.NextResponse.json({success:!1,error:o.error},{status:500})}catch(e){return console.error("Test rejection email error:",e),s.NextResponse.json({success:!1,error:e instanceof Error?e.message:"Unknown error"},{status:500})}}let c=new a.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/admin/test-rejection-email/route",pathname:"/api/admin/test-rejection-email",filename:"route",bundlePath:"app/api/admin/test-rejection-email/route"},resolvedPagePath:"/Users/tan135/thankyouthomas/app/api/admin/test-rejection-email/route.ts",nextConfigOutput:"",userland:t}),{requestAsyncStorage:u,staticGenerationAsyncStorage:m,serverHooks:l}=c,x="/api/admin/test-rejection-email/route";function g(){return(0,i.patchFetch)({serverHooks:l,staticGenerationAsyncStorage:m})}},6119:(e,o,r)=>{r.d(o,{AY:()=>i,Cz:()=>a,xu:()=>n});let t=r(5245).createTransport({host:process.env.SMTP_HOST,port:parseInt(process.env.SMTP_PORT||"587"),secure:"true"===process.env.SMTP_SECURE,auth:{user:process.env.SMTP_USER,pass:process.env.SMTP_PASS},tls:{rejectUnauthorized:!1}});async function a({to:e,subject:o,html:r}){try{let a=await t.sendMail({from:`"${process.env.SMTP_FROM_NAME}" <${process.env.SMTP_FROM_EMAIL}>`,to:e,subject:o,html:r});return{success:!0,messageId:a.messageId}}catch(e){return{success:!1,error:e instanceof Error?e.message:"Unknown error"}}}function n(e,o){return`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
  ...
  `}}};var o=require("../../../../webpack-runtime.js");o.C(e);var r=e=>o(o.s=e),t=o.X(0,[276,972,245],()=>r(6917));module.exports=t})();