"use strict";(()=>{var e={};e.id=452,e.ids=[452],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1282:e=>{e.exports=require("child_process")},4770:e=>{e.exports=require("crypto")},665:e=>{e.exports=require("dns")},7702:e=>{e.exports=require("events")},2048:e=>{e.exports=require("fs")},2615:e=>{e.exports=require("http")},8791:e=>{e.exports=require("https")},8216:e=>{e.exports=require("net")},9801:e=>{e.exports=require("os")},5315:e=>{e.exports=require("path")},6162:e=>{e.exports=require("stream")},2452:e=>{e.exports=require("tls")},7360:e=>{e.exports=require("url")},1764:e=>{e.exports=require("util")},1568:e=>{e.exports=require("zlib")},3263:e=>{e.exports=import("firebase-admin/app")},2929:e=>{e.exports=import("firebase-admin/firestore")},4988:(e,o,t)=>{t.a(e,async(e,r)=>{try{t.r(o),t.d(o,{originalPathname:()=>g,patchFetch:()=>d,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>x,staticGenerationAsyncStorage:()=>l});var a=t(9303),n=t(8716),s=t(670),i=t(9553),p=e([i]);i=(p.then?(await p)():p)[0];let c=new a.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/admin/approve/route",pathname:"/api/admin/approve",filename:"route",bundlePath:"app/api/admin/approve/route"},resolvedPagePath:"/Users/tan135/thankyouthomas/app/api/admin/approve/route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:u,staticGenerationAsyncStorage:l,serverHooks:x}=c,g="/api/admin/approve/route";function d(){return(0,s.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:l})}r()}catch(e){r(e)}})},9553:(e,o,t)=>{t.a(e,async(e,r)=>{try{t.r(o),t.d(o,{POST:()=>p});var a=t(7070),n=t(7096),s=t(6119),i=e([n]);async function p(e){try{if(!function(e){let o=e.cookies.get("admin-session")?.value;if(!o)return!1;try{let[e,t]=Buffer.from(o,"base64").toString().split(":"),r=parseInt(t),a=Date.now();return e===process.env.ADMIN_USERNAME&&a-r<288e5}catch{return!1}}(e))return a.NextResponse.json({success:!1,error:"Unauthorized"},{status:401});let{messageId:o}=await e.json();if(!o)return a.NextResponse.json({success:!1,error:"Message ID is required"},{status:400});let t=await n.db.collection("responses").doc(o).get();if(!t.exists)return a.NextResponse.json({success:!1,error:"Message not found"},{status:404});let r=t.data();await n.db.collection("responses").doc(o).update({isApproved:!0,approvedAt:new Date().toISOString(),rejectedAt:null});let i=await (0,s.Cz)({to:r?.email,subject:"Your Thank You Message Has Been Approved!",html:(0,s.xu)(r?.name||"Friend",r?.message||"")});return i.success&&await n.db.collection("responses").doc(o).update({notificationSent:!0}),a.NextResponse.json({success:!0,message:"Message approved and notification sent!",emailSent:i.success})}catch(e){return console.error("Error approving message:",e),a.NextResponse.json({success:!1,error:"Failed to approve message"},{status:500})}}n=(i.then?(await i)():i)[0],r()}catch(e){r(e)}})},6119:(e,o,t)=>{t.d(o,{AY:()=>s,Cz:()=>a,xu:()=>n});let r=t(5245).createTransport({host:process.env.SMTP_HOST,port:parseInt(process.env.SMTP_PORT||"587"),secure:"true"===process.env.SMTP_SECURE,auth:{user:process.env.SMTP_USER,pass:process.env.SMTP_PASS},tls:{rejectUnauthorized:!1}});async function a({to:e,subject:o,html:t}){try{let a=await r.sendMail({from:`"${process.env.SMTP_FROM_NAME}" <${process.env.SMTP_FROM_EMAIL}>`,to:e,subject:o,html:t});return{success:!0,messageId:a.messageId}}catch(e){return{success:!1,error:e instanceof Error?e.message:"Unknown error"}}}function n(e,o){return`
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
